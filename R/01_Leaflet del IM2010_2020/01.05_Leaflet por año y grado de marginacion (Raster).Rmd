...
- `Tipo de Datos`: El tipo de datos en el shapefile (`puntos`, `líneas`, `polígonos`) puede influir en el método de rasterización. Más adelante se trabará con la conversión de cada uno de estos datos. 
