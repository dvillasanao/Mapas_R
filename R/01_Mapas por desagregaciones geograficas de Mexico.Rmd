...
```
```{r, eval = FALSE}
path = paste0(here::here(),"/img/IML_2020_por estado_geom_polygon.pdf")
ggexport(list = tabla, filename = path, width = 8, height = 6, res = 400, device = "cairo")
```
...
```{r, eval = FALSE}
path = paste0(here::here(),"/img/IML_2020_tmap.pdf")
ggexport(p, filename = path, width = 8, height = 6, res = 400, device = "cairo")
```
...
```{r, eval = FALSE}
path = paste0(here::here(),"/img/IML_2020_geom_sf.pdf")
