...
```{r, eval = FALSE}
path = paste0(here::here(),"/img/IME_2020_tmap.pdf")
ggexport(p, filename = path, width = 10, height = 6, res = 400, device = "cairo")
```

![](../img/IME_2020_tmap.png){width="70%" fig-align="center"}  
